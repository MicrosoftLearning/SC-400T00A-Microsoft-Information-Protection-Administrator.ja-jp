...
このタスクでは、**内部**秘密度ラベルの下に、特に、従業員の機密情報を含んだ人事ドキュメントを保護するためのサブラベルを作成します。 このラベルにより、アクセスが人事担当者に限定され、Microsoft 365 Copilot などのツールを通じてアクセスした場合でも情報の保護が確実に維持されるようになります。
...
1. **[アクセス許可の割り当て]** ポップアップ ページで、**[+ 任意の認証済みユーザーを追加]** を選択し、**[保存]** を選択します。
