...
1. セッションが完全にクリアされるように、すべてのブラウザー ウィンドウを閉じます。

1. **Microsoft Edge** を開き、Microsoft Purview ポータル (**`https://purview.microsoft.com`**) にアクセスします。
...
1. **[新しい Microsoft Purview ポータルへようこそ]** で **[開始する]** を選択します。 使用します。
