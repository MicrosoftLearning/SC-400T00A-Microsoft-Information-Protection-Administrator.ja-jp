---
ms.openlocfilehash: 0326f4a46267030e3719939049af3891e317b496
ms.sourcegitcommit: c78ddb966a982b76e7f46fc17a42847f76d6e1a0
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 07/15/2022
ms.locfileid: "147154843"
---
...
1. **[ポリシーの名前を設定]** ページで、次の情報を入力します。
    ...
    - **[説明]** : 従業員の ID 番号と疾病がエンドポイントで共有されるのを防止する。
...
1. **[ルールの作成]** ページで、次の情報を入力します。
    ...
    - **[説明]** : 従業員の ID と疾病が近い範囲で共有されている場合を検出する。
...
1. すべてのチェックボックスをオンのままにし、いずれかのチェックボックスから直接ドロップダウンの選択項目を **[監査]** から **[ブロック]** に変更します。

1. **[ユーザー通知]** の下で、スイッチを選択し、 **[オン]** の位置に設定します。 **[エンドポイント デバイス]** の下で、 **[アクティビティが制限されている場合にユーザーにポリシー ヒント通知を表示する] を選択します。Windows でアクティビティに対して [ブロック] を選択すると、これはオンになります。Windows デバイスで通知をオフにするには、制限を無効にします。**
...
1. **[除外するパスを入力]** フィールドに「C:\FilePathExclusionTest」と入力し、**[+]** を選択します。
...
1. 右側のウィンドウの **[ドメイン]** の下に「**dropbox.com**」と入力し、 **+** 記号を選択し、 **[追加]** を選択します。
...
1. **[「Microsoft Purview 拡張機能」を追加しますか?]** ウィンドウで、 **[拡張機能を追加]** を選択します。
