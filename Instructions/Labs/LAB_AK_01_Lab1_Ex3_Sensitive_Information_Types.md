...
1. **[基本設定]** で、"**名前**" フィールドに「*EDM_DataUploaders*」と入力します。  "説明" フィールドに「*EDM のデータをアップロードするユーザー*」と入力します。
...
1. 最初の **[スキーマ フィールド名]** に「*Name*」と入力し、**[フィールドは検索可能]** にマークを付けます。
...
1. **[キーワード辞書の追加]** ページで、名前を「*病名の辞書*」と入力します。 
