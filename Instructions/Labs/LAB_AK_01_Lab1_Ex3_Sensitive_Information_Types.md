---
ms.openlocfilehash: 5577eee447a1dcf03dee86cf47d7163dc08fecbc
ms.sourcegitcommit: c78ddb966a982b76e7f46fc17a42847f76d6e1a0
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 07/15/2022
ms.locfileid: "147154849"
---
...
1. **[設定の確認と終了]** ページで設定を確認し、**[作成]** を選択します。 When successfully created select <bpt id="p1">**</bpt>Done<ept id="p1">**</ept>.
...
1. **[基本設定]** で **[名前]** フィールドに「*EDM_DataUploaders*」と入力します。  [説明] フィールドに「EDM にデータをアップロードする人」と入力します。
...
1. **[+ EDM スキーマを作成]** を選択して右側のウィンドウを開き、新しいスキーマの定義を作成します。
...
1. **[無視する区切り記号と句読点を選択する]** を選択し、*ハイフン*、*ピリオド*、*スペース*、*開きかっこ*、*閉じかっこ* を選択します。

1. 最初の **[スキーマ フィールド名]** に「*名前*」と入力し、**[フィールドは検索可能]** にマークを付けます。
...
1. **[Primary element's sensitive info type]\(主要要素の機密情報の種類\)** で、**[Choose sensitive info type]\(機密情報の種類を選択する\)** を選択します。 
...
1. **[Name and describe your EDM sensitive info type]\(名前と EDM 機密情報の種類の説明\)** ページで、名前として「*Contoso Employee EDM*」と入力します。
...
1. 左側のウィンドウから **[ドキュメント]** を選択し、**[ファイル名]** フィールドに「*EmployeeData.csv*」と入力します。
...
1. **[キーワード辞書の追加]** ページで、「*Diseases Dictionary*」という名前を入力します。 
