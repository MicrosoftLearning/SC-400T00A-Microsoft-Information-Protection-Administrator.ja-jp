...
5. 信頼されていないリポジトリ セキュリティ ダイアログで "はい" の **Y** を入力して確認し、Enter キーを押します。  処理が完了するまでに数秒かかる場合があります。

6. 次のコマンドレットを入力して、最新の SharePoint Online PowerShell モジュール バージョンをインストールします。

    `Install-Module -Name Microsoft.Online.SharePoint.PowerShell`

7. 信頼されていないリポジトリ セキュリティ ダイアログで "はい" の **Y** を入力して確認し、Enter キーを押します。
...
4. [情報の保護] ページの **[ラベル]** タブで、**[+ ラベルの作成]** を選択します。

5. **[新しい秘密度ラベル]** ウィザードが起動します。 **[ラベルに名前を付けてヒントを作成する]** ページで、**[名前]**、**[管理者向けの説明]**、**[ユーザー向けの説明]** に次の情報を入力します。
...
5. 秘密度ラベルの発行ウィザードが起動します。

6. **[発行する秘密度ラベルの選択]** ページで、**[発行する秘密度ラベルの選択]** リンクを選択します。

7. 右側には、**[発行する秘密度ラベル]** というサイド バーが表示されます。

8. **[内部]** と **[内部/従業員データ (HR)]** チェックボックスをオンにします。

9. **[追加]** を選択します。

10. **[発行する秘密度ラベルの選択]** ページで **[次へ]** を選択します。
...
16. **[ポリシーの名前を設定する]** ページで、次の情報を入力します。
...
10. タブを閉じて、[Word Online] タブに戻ります。左側のペインから Outlook のシンボルを選択して、Outlook on the web を開きます。
...
14. [件名] フィールドに「**HR 用従業員データ**」と入力します。
...
16. 下部のメニューからクリップのシンボルを選択し、**[添付ファイルの候補]** の下から **HR Document.docx** を選択してドキュメントを添付します。
...
4. [情報の保護] ページで、既存の **[内部]** ラベルを (選択せずに) 強調表示し、省略記号 (3 つの点) を選択します。
...
10. **[ファイルとメールの保護設定を選択]** ページで、**[次へ]** をクリックします。
...
26. 秘密度ラベルの発行ウィザードが起動します。

27. **[発行する秘密度ラベルの選択]** ページで、**[発行する秘密度ラベルの選択]** リンクを選択します。
...
31. **[発行する秘密度ラベルの選択]** ページで **[次へ]** を選択します。
...
37. **[ポリシーの名前を設定する]** ページで、次の情報を入力します。
