---
ms.openlocfilehash: 63882b1e36508638e9926f2221cbf155560db76c
ms.sourcegitcommit: c78ddb966a982b76e7f46fc17a42847f76d6e1a0
ms.translationtype: HT
ms.contentlocale: ja-JP
ms.lasthandoff: 07/15/2022
ms.locfileid: "147154808"
---
...
1. 上部のウィンドウから、**[暗号化]** を選択し、メッセージを暗号化します。  メッセージが正常に暗号化されると、"暗号化: このメッセージは暗号化されています。 受信者は暗号化を削除できません" のような通知が表示されるはずです。
